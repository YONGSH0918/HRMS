        ...
        <div id="Aboutme" class="tabcontent">
            <div class="form-row" style="padding: 5%;">
                ...
                <div id="special" class="search_select_box form-group col-sm-6">
                    ...
                    <select id="race" name="race" data-live-search="true" onchange="if (this.value=='Others'){this.form['othersrace'].style.visibility='visible'}
                ...
                <div id="special" class="search_select_box form-group col-sm-6">
                    ...
                    <select id="religion" name="religion" data-live-search="true" onchange="if (this.value=='Others'){this.form['others'].style.visibility='visible'}
