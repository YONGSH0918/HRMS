        ...
        <div class="col-md-8 float-left" style="border-radius: 10px; background-color: whitesmoke;">
            <div class="box box-success" style="padding: 10px;">
                ...
                <div class="box-body employee-info">
                    ...
                    <form name="formEditMeCPD" class="form-horizontal" role="form" method="POST" action="{{ route('updateMeCPD', ['id' => $cpd->id]) }}" enctype="multipart/form-data">
                        @csrf
                        <button type="submit" name="editMeCPD" class="btn btn-primary" onclick="return confirm('Are you sure you want to start?')">
                            Start
                        </button>
                    </form>
                    @endif
