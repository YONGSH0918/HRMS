            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form name="formAddEmployee" class="form-horizontal" role="form" method="POST" action="{{ route('addEmployee') }}" enctype="multipart/form-data" onSubmit="return formValidation();">
                        ...
                        <!--Employee Calendar ID-->
                        <div class="form-group">
                            <label for="calendar_ID" class="col-md-4 control-label">Calendar ID<span style="color:red">*</span></label>
                            <div class="col-md-6">
                                <input type="text" id="calendar_ID" name="calendar_ID" style= "width: -webkit-fill-available;" required>
                            </div>
                        </div>
