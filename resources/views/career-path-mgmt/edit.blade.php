    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" style="font-size: larger; color: mediumblue; font-weight: 500;">Edit employee</div>
                <div class="panel-body">
                    <form name="formEditEmployee" class="form-horizontal" role="form" method="POST" action="{{ route('updateEmployee') }}" enctype="multipart/form-data" onSubmit="return formValidation();">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" name="address" value="{{$employee->address}}" style= "width: -webkit-fill-available;" required></textarea>
                            </div>
                        </div>
